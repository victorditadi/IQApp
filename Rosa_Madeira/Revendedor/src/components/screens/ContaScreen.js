            ...
            <View style={{flex: 1, marginTop: 50}}>
              <Card>
                <View style={Styles.containerInfoStyle}>
                  <Text style={{color:'black', fontSize: 15, textAlign:'center'}}>Revendedor: Rafael Roriz</Text>
                </View>
              </Card>
              <Card>
                <View style={Styles.containerInfoStyle}>
                  <Text style={{color:'black', fontSize: 15, textAlign:'center'}}>ID Revendedor: 1</Text>
                </View>
              </Card>
              <Card>
                <View style={Styles.containerInfoStyle}>
